...
<Accordion title="When should I use a temporary vs. permanent redirect?">
  A 301 is used when a page has permanently changed location, and a 302 should
  be used if you intend to move the page back under the original URL in the
  future. In general, you should expect to use 301 redirects on your website.
</Accordion>
